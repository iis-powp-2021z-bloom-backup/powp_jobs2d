...
import edu.kis.powp.jobs2d.drivers.adapter.DriveFigure;
...
public class TestJobs2dPatterns {
	...
	private static void setupPresetTests(Application application) {
		...
		application.addTest("Test1", selectTestFigureOptionListener);
		application.addTest("Test2", selectTestFigureOptionListener);
	...
	private static void setupDrivers(Application application) {
		...
		Job2dDriver testDriver = new DriveFigure();
